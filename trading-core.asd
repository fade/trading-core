...
(asdf:defsystem #:trading-core
  ...
  :author "Jonathan Lee"
  :license "MIT"
  :depends-on (#:rutils #:cl-ppcre #:log4cl #:cl-mustache #:local-time
  ...
  :components ((:file "circular-buffer")
               ...
               (:file "trading-agents/fractal-ama-trend-following")
               (:file "trading-agents/market-direction-filter")
